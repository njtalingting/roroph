...
> *Maintainer's Note: `roroph` exclusively covers operational data starting 2024 to the present since it was only the time when maritime reporting under MARINA and the PPA has undergone a mandatory shift toward digital standardization per Executive Order No. 55 (Adopting the MIDP 2028). Regardless, I am actively maintaining this dataset to reflect the current maritime landscape. If you are aware of newly established inter-island RoRo routes not yet captured, or routes that have ceased operations since 2024, please submit an issue.*
